#Includes A* instead of Dynamic Programming
#Includes PID Controller with Smoothing and CTE Calculation
#Includes Twiddle or Coordinate Ascent (Algorithm to find good Control Gains for PID Controller)
